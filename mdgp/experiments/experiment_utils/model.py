...
class ModelArguments:
    ...
    hidden_output_dims: int = field(default=3, metadata={'help': 'Number of dimensions of the hidden output'})
...
def get_inducing_points(num_inducing: int, space: Space) -> Tensor:
    ...
    raise ValueError(f"Unsupported space: {space}. Must be one of [Hypersphere(dim=2)].")
