...
def run_experiment(experiment_config: ExperimentConfig, dir_path: str):
    ...
    model = create_model(model_args=model_args, train_x=train_inputs, train_y=train_targets) # TODO add train_x, train_y to arguments of create_model 
