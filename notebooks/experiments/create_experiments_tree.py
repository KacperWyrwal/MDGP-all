...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir_path', type=str, default='../../experiments/', help='The directory to save the config files to')
    parser.add_argument('--config_path', type=str, default='../../experiments/euclidean_dgp.json', help='The path to the config file to create')
