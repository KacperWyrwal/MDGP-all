...
class Kin8mn(Dataset):
    ...
    def download_data(self):
        ...
        # NOTE The original data was taken from mldata.org, which seems to have been down since late 2017.
        # url = 'http://mldata.org/repository/data/download/csv/uci-20070111-kin8nm'
        url = 'https://raw.githubusercontent.com/liusiyan/UQnet/master/datasets/UCI_datasets/kin8nm/dataset_2175_kin8nm.csv'
